...
"[project]/Desktop/nextProjectTest/testTasks/firstTestTask/app-1/app/register/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Page = ()=>{
    ...
    const onSubmit = (data)=>{
        ...
        if (checkStorage) {
            ...
            if (user) {
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$nextProjectTest$2f$testTasks$2f$firstTestTask$2f$app$2d$1$2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("User already exists");
            } else {
                localStorage.setItem("users", JSON.stringify([
                    ...users,
                    data
                ]));
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$nextProjectTest$2f$testTasks$2f$firstTestTask$2f$app$2d$1$2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("User registered successfully");
            }
        }
        reset();
    };
...
//# sourceMappingURL=Desktop_nextProjectTest_testTasks_firstTestTask_app-1_cdd8426d._.js.map